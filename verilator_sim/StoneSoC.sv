...
module SimpleUART(	// src/main/scala/soc/SoC.scala:128:7
  output io_tx,	// src/main/scala/soc/SoC.scala:129:14
  input  io_rx	// src/main/scala/soc/SoC.scala:129:14
);

  assign io_tx = io_rx;	// src/main/scala/soc/SoC.scala:128:7
endmodule
...
module PerfMonitor(	// src/main/scala/sim/PerfMonitor.scala:8:7
  ...
  output [63:0] io_perf_data_cycles,	// src/main/scala/sim/PerfMonitor.scala:9:14
                io_perf_data_instructions,	// src/main/scala/sim/PerfMonitor.scala:9:14
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/sim/PerfMonitor.scala:8:7
    ...
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  assign io_perf_data_cycles = cycle_counter;	// src/main/scala/sim/PerfMonitor.scala:8:7, :39:30
  assign io_perf_data_instructions = instruction_counter;	// src/main/scala/sim/PerfMonitor.scala:8:7, :40:36
...
module SoCPerfMonitor(	// src/main/scala/sim/PerfMonitor.scala:113:7
  ...
  output [31:0] io_debug_perf_cycles_per_second,	// src/main/scala/sim/PerfMonitor.scala:114:14
                io_debug_perf_instructions_per_second,	// src/main/scala/sim/PerfMonitor.scala:114:14
                io_debug_perf_avg_ipc	// src/main/scala/sim/PerfMonitor.scala:114:14
);

  wire [63:0] _perf_monitor_io_perf_data_cycles;	// src/main/scala/sim/PerfMonitor.scala:127:28
  wire [63:0] _perf_monitor_io_perf_data_instructions;	// src/main/scala/sim/PerfMonitor.scala:127:28
  reg  [31:0] cycles_per_second;	// src/main/scala/sim/PerfMonitor.scala:154:34
  reg  [31:0] instructions_per_second;	// src/main/scala/sim/PerfMonitor.scala:155:40
  reg  [31:0] second_counter;	// src/main/scala/sim/PerfMonitor.scala:156:31
  reg  [31:0] last_cycles;	// src/main/scala/sim/PerfMonitor.scala:157:28
  reg  [31:0] last_instructions;	// src/main/scala/sim/PerfMonitor.scala:158:34
  always @(posedge clock) begin	// src/main/scala/sim/PerfMonitor.scala:113:7
    if (reset) begin	// src/main/scala/sim/PerfMonitor.scala:113:7
      cycles_per_second <= 32'h0;	// src/main/scala/sim/PerfMonitor.scala:154:34
      instructions_per_second <= 32'h0;	// src/main/scala/sim/PerfMonitor.scala:154:34, :155:40
      second_counter <= 32'h0;	// src/main/scala/sim/PerfMonitor.scala:154:34, :156:31
      last_cycles <= 32'h0;	// src/main/scala/sim/PerfMonitor.scala:154:34, :157:28
      last_instructions <= 32'h0;	// src/main/scala/sim/PerfMonitor.scala:154:34, :158:34
    end
    else if (second_counter == 32'h5F5E0FF) begin	// src/main/scala/sim/PerfMonitor.scala:156:31, :162:23
      cycles_per_second <= _perf_monitor_io_perf_data_cycles[31:0] - last_cycles;	// src/main/scala/sim/PerfMonitor.scala:127:28, :154:34, :157:28, :164:{58,66}
      instructions_per_second <=
        _perf_monitor_io_perf_data_instructions[31:0] - last_instructions;	// src/main/scala/sim/PerfMonitor.scala:127:28, :155:40, :158:34, :165:{70,78}
      second_counter <= 32'h0;	// src/main/scala/sim/PerfMonitor.scala:154:34, :156:31
      last_cycles <= _perf_monitor_io_perf_data_cycles[31:0];	// src/main/scala/sim/PerfMonitor.scala:127:28, :157:28, :164:58
      last_instructions <= _perf_monitor_io_perf_data_instructions[31:0];	// src/main/scala/sim/PerfMonitor.scala:127:28, :158:34, :165:70
    end
    else	// src/main/scala/sim/PerfMonitor.scala:162:23
      second_counter <= second_counter + 32'h1;	// src/main/scala/sim/PerfMonitor.scala:156:31, :160:36
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/sim/PerfMonitor.scala:113:7
    `ifdef FIRRTL_BEFORE_INITIAL	// src/main/scala/sim/PerfMonitor.scala:113:7
      `FIRRTL_BEFORE_INITIAL	// src/main/scala/sim/PerfMonitor.scala:113:7
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// src/main/scala/sim/PerfMonitor.scala:113:7
      automatic logic [31:0] _RANDOM[0:4];	// src/main/scala/sim/PerfMonitor.scala:113:7
      `ifdef INIT_RANDOM_PROLOG_	// src/main/scala/sim/PerfMonitor.scala:113:7
        `INIT_RANDOM_PROLOG_	// src/main/scala/sim/PerfMonitor.scala:113:7
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/sim/PerfMonitor.scala:113:7
        for (logic [2:0] i = 3'h0; i < 3'h5; i += 3'h1) begin
          _RANDOM[i] = `RANDOM;	// src/main/scala/sim/PerfMonitor.scala:113:7
        end	// src/main/scala/sim/PerfMonitor.scala:113:7
        cycles_per_second = _RANDOM[3'h0];	// src/main/scala/sim/PerfMonitor.scala:113:7, :154:34
        instructions_per_second = _RANDOM[3'h1];	// src/main/scala/sim/PerfMonitor.scala:113:7, :155:40
        second_counter = _RANDOM[3'h2];	// src/main/scala/sim/PerfMonitor.scala:113:7, :156:31
        last_cycles = _RANDOM[3'h3];	// src/main/scala/sim/PerfMonitor.scala:113:7, :157:28
        last_instructions = _RANDOM[3'h4];	// src/main/scala/sim/PerfMonitor.scala:113:7, :158:34
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// src/main/scala/sim/PerfMonitor.scala:113:7
      `FIRRTL_AFTER_INITIAL	// src/main/scala/sim/PerfMonitor.scala:113:7
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  PerfMonitor perf_monitor (	// src/main/scala/sim/PerfMonitor.scala:127:28
    ...
    .io_perf_data_cycles       (_perf_monitor_io_perf_data_cycles),
    .io_perf_data_instructions (_perf_monitor_io_perf_data_instructions),
    .io_perf_data_ipc          (io_debug_perf_avg_ipc)
  );
  assign io_debug_perf_cycles_per_second = cycles_per_second;	// src/main/scala/sim/PerfMonitor.scala:113:7, :154:34
  assign io_debug_perf_instructions_per_second = instructions_per_second;	// src/main/scala/sim/PerfMonitor.scala:113:7, :155:40
endmodule
...
module TraceGenerator(	// src/main/scala/sim/PerfMonitor.scala:176:7
  ...
  output [63:0] io_trace_out_cycle	// src/main/scala/sim/PerfMonitor.scala:177:14
);
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/sim/PerfMonitor.scala:176:7
    ...
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  assign io_trace_out_cycle = cycle_counter;	// src/main/scala/sim/PerfMonitor.scala:176:7, :196:30
endmodule
...
module StoneSoC(	// src/main/scala/soc/SoC.scala:28:7
  ...
  output        io_uart_tx,	// src/main/scala/soc/SoC.scala:29:14
  input         io_uart_rx,	// src/main/scala/soc/SoC.scala:29:14
  output [31:0] io_gpio_out,	// src/main/scala/soc/SoC.scala:29:14
  input  [31:0] io_gpio_in,	// src/main/scala/soc/SoC.scala:29:14
  output [31:0] io_debug_perf_cycles_per_second,	// src/main/scala/soc/SoC.scala:29:14
                io_debug_perf_instructions_per_second,	// src/main/scala/soc/SoC.scala:29:14
                io_debug_perf_avg_ipc,	// src/main/scala/soc/SoC.scala:29:14
  output        io_debug_trace_valid,	// src/main/scala/soc/SoC.scala:29:14
  output [31:0] io_debug_trace_pc,	// src/main/scala/soc/SoC.scala:29:14
                io_debug_trace_inst,	// src/main/scala/soc/SoC.scala:29:14
  output [4:0]  io_debug_trace_rd_addr,	// src/main/scala/soc/SoC.scala:29:14
  output [31:0] io_debug_trace_rd_data,	// src/main/scala/soc/SoC.scala:29:14
  output [63:0] io_debug_trace_cycle	// src/main/scala/soc/SoC.scala:29:14
);
  ...
  SimpleCache icache (	// src/main/scala/soc/SoC.scala:59:22
    .clock                (clock),
    .reset                (reset),
    .io_cpu_req_valid     (1'h1),	// src/main/scala/soc/SoC.scala:54:19, :59:22, :60:22, :64:20, :65:21, :66:20, :83:16, :88:16
    .io_cpu_req_bits_addr (_cpu_io_imem_req_bits_addr),	// src/main/scala/soc/SoC.scala:54:19
    .io_cpu_req_bits_data (32'h0),	// src/main/scala/soc/SoC.scala:28:7, :59:22, :66:20
    .io_cpu_req_bits_mask (4'h0),	// src/main/scala/soc/SoC.scala:54:19, :59:22, :64:20, :65:21, :66:20, :83:16
    .io_cpu_req_bits_wen  (1'h0),	// src/main/scala/soc/SoC.scala:28:7, :54:19, :59:22, :64:20, :65:21, :66:20, :83:16, :88:16
  ...
  SimpleUART uart (	// src/main/scala/soc/SoC.scala:64:20
    .io_tx (io_uart_tx),
    .io_rx (io_uart_rx)
  );
  SoCPerfMonitor perf_monitor (	// src/main/scala/soc/SoC.scala:83:16
    ...
    .io_debug_perf_cycles_per_second       (io_debug_perf_cycles_per_second),
    .io_debug_perf_instructions_per_second (io_debug_perf_instructions_per_second),
    .io_debug_perf_avg_ipc                 (io_debug_perf_avg_ipc)
  );
  TraceGenerator trace_gen (	// src/main/scala/soc/SoC.scala:88:16
    .clock              (clock),
    .reset              (reset),
    .io_trace_out_cycle (io_debug_trace_cycle)
  );
  assign io_gpio_out = 32'h0;	// src/main/scala/soc/SoC.scala:28:7, :59:22, :66:20
  assign io_debug_trace_valid = 1'h0;	// src/main/scala/soc/SoC.scala:28:7, :54:19, :59:22, :64:20, :65:21, :66:20, :83:16, :88:16
  assign io_debug_trace_pc = 32'h0;	// src/main/scala/soc/SoC.scala:28:7, :59:22, :66:20
  assign io_debug_trace_inst = 32'h0;	// src/main/scala/soc/SoC.scala:28:7, :59:22, :66:20
  assign io_debug_trace_rd_addr = 5'h0;	// src/main/scala/soc/SoC.scala:28:7, :88:16
  assign io_debug_trace_rd_data = 32'h0;	// src/main/scala/soc/SoC.scala:28:7, :59:22, :66:20
endmodule
